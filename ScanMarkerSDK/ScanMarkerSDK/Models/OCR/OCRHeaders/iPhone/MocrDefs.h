...
typedef enum tagMocrImageProcessingOptionsFlags {
	...
	// If this flag is set, then old binarization algorithm is used in process of recognition.
	// Old binarization is slower, but it may provide the better recognition results when using CJK languages.
	MIPO_UseOldBinarization = 1 << 11
