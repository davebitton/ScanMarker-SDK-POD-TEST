...
#  else                         /* gunzip is also in the gnu locker */
...
#define GS_PATH "/usr/athena/bin/gs"
/* #define GS_LIB  "/afs/athena/project/gnu/share/ghostscript/current -I/afs/athena/project/gnu/share/ghostscript/fonts" */
